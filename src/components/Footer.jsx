// Fixed footer mirroring contact icons from the About section.
export function Footer() {
  return (
    <footer
      id="contact"
      className="fixed bottom-0 left-0 right-0 h-[var(--footer-height)] bg-violet-jtc text-dutch-white flex items-center justify-center gap-8 text-sm z-40"
      aria-label="Footer"
    >
      <FooterLink href="mailto:mpawlowski5467@gmail.com" label="Email">
      ...
      <FooterLink href="https://github.com/Mpawlowski5467" label="GitHub">
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5" aria-hidden="true">
      ...
      <FooterLink href="https://www.linkedin.com" label="LinkedIn">
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5" aria-hidden="true">
...
function FooterLink({ href, label, children }) {
  return (
    <a
      href={href}
      aria-label={label}
      className="flex items-center gap-1 focus:outline-none focus:ring-2 focus:ring-plum rounded-md"
