export const translations = {
  en: {
    header: {
      ...
      role: 'AI Intern & Information Technology Student'
    },
    nav: {
      about: 'About',
    ...
    experience: {
      title: 'Experience',
      role: 'AI Intern — Reyes Holdings LLC',
    ...
    education: {
      title: 'Education',
      items: [
        "DePaul University — B.S. in Information Technology (Aug 2023 – Present), GPA 3.67, Dean's List Fall 2023",
        'Harper College — Associate in Business, Entrepreneurship, IT (Aug 2021 – Aug 2023)'
      ]
    },
    skills: {
      title: 'Skills',
  ...
  pl: {
    header: {
      name: 'Mateusz Pawłowski',
      role: 'Stażysta AI i student technologii informacyjnych'
    },
    nav: {
      about: 'O mnie',
    ...
    experience: {
      title: 'Doświadczenie',
      role: 'Stażysta AI — Reyes Holdings LLC',
      date: 'Czerwiec 2024 – obecnie',
      bullets: [
    ...
    education: {
      title: 'Edukacja',
      items: [
        'Uniwersytet DePaul — licencjat z technologii informacyjnych (sierpień 2023 – obecnie), GPA 3,67, Lista Dziekana jesień 2023',
        'Harper College — Associate in Business, Entrepreneurship, IT (sierpień 2021 – sierpień 2023)'
      ]
    },
    skills: {
      title: 'Umiejętności',
